...
db.prototype = {
	...
	{
		// let label = window.prompt("Enter a Label for the card","Task"); prompts user for a card label
		// var label = card.label; not entering here from front, console log never happens
		console.log('in create card event:' + card);
